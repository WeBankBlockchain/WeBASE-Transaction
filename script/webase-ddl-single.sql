...
-- create database
-- ----------------------------
CREATE DATABASE IF NOT EXISTS webasetransaction;

-- ----------------------------
-- use webasetransaction
-- ----------------------------
use webasetransaction;
...
-- create table
-- ----------------------------
DROP TABLE IF EXISTS tb_deploy_transaction;
...
DROP TABLE IF EXISTS tb_stateless_transaction;
