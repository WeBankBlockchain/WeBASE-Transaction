...
import com.webank.webase.transaction.frontinterface.entity.FailInfo;
...
public class FrontRestTools {
    ...
    private static final List<String> URI_NOT_CONTAIN_GROUP_ID = Arrays.asList(
            URI_MULTI_CONTRACT_COMPILE, URI_CONTRACT_DEPLOY, URI_SEND_TRANSACTION,
            URI_SYS_CONFIG_LIST, URI_SYS_CONFIG, URI_CONSENSUS_LIST, URI_CONSENSUS,
            URI_CONTRACT_STATUS_MANAGE, URI_CERT, URI_ENCRYPT_TYPE, URI_CHARGING_GET_NETWORK_DATA,
            URI_CHARGING_GET_TXGASDATA, URI_CHARGING_DELETE_DATA, URI_SIGNED_TRANSACTION,
            URI_QUERY_TRANSACTION, URI_CHAIN, FRONT_PERFORMANCE_RATIO, FRONT_PERFORMANCE_CONFIG,
