 ...
 * the License.
 */
package com.webank.webase.transaction.web3api;

import com.webank.webase.transaction.base.ConstantCode;
import com.webank.webase.transaction.base.NodeStatus;
import com.webank.webase.transaction.base.exception.BaseException;
import com.webank.webase.transaction.base.exception.TransactionException;
import com.webank.webase.transaction.config.Web3Config;
import com.webank.webase.transaction.util.JsonUtils;
import com.webank.webase.transaction.web3api.entity.NodeStatusInfo;
import com.webank.webase.transaction.web3api.entity.RspStatBlock;
import com.webank.webase.transaction.web3api.entity.TransactionInfo;
...
//    private Map<String, Client> clientMap;
    ...
    public Client getWeb3j(String groupId) {
        ...
        if (GROUP_AVAILABLE_MAP.get(groupId) != null && !GROUP_AVAILABLE_MAP.get(groupId)) {
            ...
            throw new TransactionException(ConstantCode.CLIENT_NOT_CONNECTED_WITH_THIS_GROUP);
        }
//        return bcosSDK.getClient(groupId);
     ...
     * @return
     */
    private Client getWeb3jRaw(String groupId) {
    ...
    public Block getBlockByNumber(String groupId, BigInteger blockNumber, boolean fullTrans) {
        if (blockNumberCheck(groupId, blockNumber)) {
            throw new TransactionException(ConstantCode.BLOCK_NUMBER_ERROR);
        }
    ...
    public Block getBlockByHash(String groupId, String blockHash, boolean fullTrans) {
        try {
            ...
            throw new TransactionException(ConstantCode.BLOCK_NOT_EXIST_ERROR);
        }
    }
    ...
    public TransactionReceipt getTransactionReceipt(String groupId, String transHash) {
        try {
            ...
            throw new TransactionException(ConstantCode.TX_RECEIPT_NOT_EXIST_ERROR);
        }
    }
    ...
    public Object searchByCriteria(String groupId, String input) {
        if (StringUtils.isBlank(input)) {
            ...
            throw new TransactionException(ConstantCode.PARAM_ERROR);
        }
